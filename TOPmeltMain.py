...
# reads snow params
(rmf, cmf, erf, albSnow, albglac, beta2, nmf, gammah) = readsnowparams(paramsetId, basinCod, cnxn,
                                                                                   snowparamsTable, log_file)
# reads general parameters
(crTemp, baseTemp, liquidW, delayTime, refreezing) = readparams(paramsetId, cnxn, parametersTable,
                                                                                  log_file)
